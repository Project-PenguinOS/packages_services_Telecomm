...
package com.android.server.telecom.shim;
...
public class TelecomShimService extends Service {

    @Override
    public IBinder onBind(Intent intent) {
        Log.i("TelecomShimService", "onBind");
        if (TelecomServiceInitializerRepository.getInitializer() != null) {
            ...
            Log.wtf("TelecomShimService", "no telecom library loaded!");
        }
        return null;
    }
}
