...
public class QuickResponseUtils {
    public static final String TAG = "QuickResponseUtils";
    ...
    public static void maybeMigrateLegacyQuickResponses(Context context) {
        ...
        Log.d(TAG, "maybeMigrateLegacyQuickResponses() - Starting");
        ...
        if (responsesExist) {
            ...
            Log.d(TAG, "maybeMigrateLegacyQuickResponses() - Telecom QuickResponses exist");
            return;
        }

        Log.d(TAG, "maybeMigrateLegacyQuickResponses() - No local QuickResponses");
        ...
        try {
            ...
            Log.e(TAG, "maybeMigrateLegacyQuickResponses() - Can't find Telephony package.", e);
        }

        // Read the old canned responses from the Telephony SharedPreference if possible.
        if (telephonyContext != null) {
            Log.d(TAG, "maybeMigrateLegacyQuickResponses() - Using Telephony QuickResponses.");
        ...
        Log.d(TAG, "maybeMigrateLegacyQuickResponses() - Done.");
        return;
    }
    ...
    public static void maybeResetQuickResponses(Context context, SharedPreferences prefs) {
        ...
        if (currentValue1.equals(defaultResponse1)) {
            ...
            Log.i(TAG, "maybeResetQuickResponses: response 1 is identical to default; clear pref.");
        }
        ...
        if (currentValue2.equals(defaultResponse2)) {
            ...
            Log.i(TAG, "maybeResetQuickResponses: response 2 is identical to default; clear pref.");
        }
        ...
        if (currentValue3.equals(defaultResponse3)) {
            ...
            Log.i(TAG, "maybeResetQuickResponses: response 3 is identical to default; clear pref.");
        }
        ...
        if (currentValue4.equals(defaultResponse4)) {
            ...
            Log.i(TAG, "maybeResetQuickResponses: response 4 is identical to default; clear pref.");
        }
    }
}
